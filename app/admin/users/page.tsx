...
import { mockUsers, mockEnrollments } from '@/lib/mock-data';
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-border bg-muted/50">
                  ...
                  <th className="px-6 py-3 text-left text-xs font-semibold text-muted-foreground uppercase tracking-wider">Age Group</th>
                ...
                {filteredUsers.length > 0 ? (
                  filteredUsers.map(user => (
                    <tr key={user.id} className="hover:bg-muted/50 transition">
                      ...
                      <td className="px-6 py-4 text-sm font-medium text-primary">{user.points}</td>
                      <td className="px-6 py-4 text-sm text-muted-foreground">{getUserEnrollmentCount(user.id)}</td>
